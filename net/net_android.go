...
var androidAddrs []net.Addr
var androidInterfaces []net.Interface

func SetInterfacesString(interfaces string) {
	androidAddrs = make([]net.Addr, 0)
	androidInterfaces = make([]net.Interface, 0)
	// Adapted from:
...
func (a *androidInterface) InterfaceAddrs() ([]net.Addr, error) {
	if len(androidAddrs) == 0 {
		return InterfaceAddrs()
	}
	return androidAddrs, nil
}
